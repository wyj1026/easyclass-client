...
class NewHomeworkTitle extends StatefulWidget {
  ...
  NewHomeworkTitle({Key key, @required this.id, @required this.classname}) : super(key: key);
          ...
          actions: <Widget>[
            new IconButton(icon: new Icon(Icons.check), onPressed: () {
              ...
              Navigator.of(context).pushReplacement(
                  MaterialPageRoute(
                      builder: (context) => new NewHomeworkWithTitle(homework: homework))
              );
            })
          ],
        ),
                    ...
                    children: <Widget>[
                      ...
                      ListTile(
                        leading: new Container(
                            ...
                            child: new Text("开始上传时间时间", style: titleStyle,)
                        ),
                        trailing: new Row(
                          ...
                          children: <Widget>[
                            ...
                            IconButton(
                                ...
                                onPressed: () async {
                                  ...
                                  _start.text = format.format(startDate).toString();
                                  setState(() {
                                  });
                                }
                            ),
                      ...
                      ListTile(
                        leading: new Container(
                            margin: const EdgeInsets.only(bottom: 6.0),
                            child: new Text("结束上传时间时间", style: titleStyle,)
                        ),
                        trailing: new Row(
                          mainAxisSize: MainAxisSize.min,
                          children: <Widget>[
                            new Text(_end.text, style: valueStyle,),
                            IconButton(
                                icon: Icon(Icons.arrow_forward_ios),
                                onPressed: () async {
